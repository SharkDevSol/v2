...
const InstallStaffApp = () => {
  ...
  useEffect(() => {
    // Set the correct manifest for Staff App
  ...
  return (
    <div className={styles.container}>
      <div className={styles.installCard}>
        <div className={styles.appIcon} style={{ background: 'linear-gradient(135deg, #ec4899, #f43f5e)' }}>
          <span style={{ fontSize: '48px' }}>👨‍🏫</span>
        </div>

        <h1 className={styles.appTitle}>Staff App</h1>
        ...
        <div className={styles.features}>
          ...
          <div className={styles.feature}>
            <FiCheck /> Enter Grades
          </div>
          <div className={styles.feature}>
            <FiCheck /> View Schedule
          </div>
          <div className={styles.feature}>
            <FiCheck /> Quick Access
          </div>
        </div>
        ...
        <div className={styles.instructions}>
          ...
          <ol>
            ...
            <li>Click the "Install Staff App" button above</li>
...
export default InstallStaffApp;
